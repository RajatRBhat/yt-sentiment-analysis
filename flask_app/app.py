...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    mlflow.set_tracking_uri("http://ec2-44-202-86-71.compute-1.amazonaws.com:5000/")  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=8000, debug=True) # test